...
* [scancode-toolkit](https://github.com/nexB/scancode-toolkit) ⭐ 2,615 | 🐛 1,677 | 🌐 Python | 📅 2026-08-28 - ScanCode detects licenses, copyrights, package manifests & dependencies and more by scanning code
* [OSS Review Toolkit](https://github.com/oss-review-toolkit/ort) ⭐ 2,077 | 🐛 324 | 🌐 Kotlin | 📅 2026-08-31 - A suite of tools to assist with reviewing Open Source Software dependencies
...
* [pip-licenses](https://github.com/raimon49/pip-licenses) ⭐ 373 | 🐛 47 | 🌐 Python | 📅 2026-08-31 - Dump the software license list of Python packages installed with pip.
