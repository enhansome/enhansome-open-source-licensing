# Awesome Open Source Licensing with stars
...
* [scancode-toolkit](https://github.com/nexB/scancode-toolkit) ⭐ 2,611 | 🐛 1,677 | 🌐 Python | 📅 2026-08-22 - ScanCode detects licenses, copyrights, package manifests & dependencies and more by scanning code
* [OSS Review Toolkit](https://github.com/oss-review-toolkit/ort) ⭐ 2,073 | 🐛 325 | 🌐 Kotlin | 📅 2026-08-24 - A suite of tools to assist with reviewing Open Source Software dependencies
...
* [pip-licenses](https://github.com/raimon49/pip-licenses) ⭐ 373 | 🐛 45 | 🌐 Python | 📅 2026-08-23 - Dump the software license list of Python packages installed with pip.
...
* [action-pip-license-checker](https://github.com/pilosus/action-pip-license-checker) ⭐ 56 | 🐛 1 | 🌐 Clojure | 📅 2026-06-22 - GitHub Action for license compliance: Python, JavaScript, iOS, Android and more.
* [pylic](https://github.com/ubersan/pylic) ⭐ 16 | 🐛 10 | 🌐 Python | 📅 2025-03-19 - Python license checker, reads pylic configuration in pyproject.toml and checks licenses of installed packages recursively.
...
* [Apache2 License Checker](https://github.com/bbc/apache2-license-checker) ⭐ 0 | 🐛 3 | 🌐 JavaScript | 📅 2023-04-18 - Automated license checker for validating project dependencies for compatible Apache2 licenses.
...
* \[free] [Plugin for checking license compatibility in IntelliJ IDEA](https://github.com/JetBrains-Research/sorrel) ⚠️ Archived
