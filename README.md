...
* [scancode-toolkit](https://github.com/nexB/scancode-toolkit) ⭐ 2,618 | 🐛 1,683 | 🌐 Python | 📅 2026-09-09 - ScanCode detects licenses, copyrights, package manifests & dependencies and more by scanning code
* [OSS Review Toolkit](https://github.com/oss-review-toolkit/ort) ⭐ 2,081 | 🐛 329 | 🌐 Kotlin | 📅 2026-09-09 - A suite of tools to assist with reviewing Open Source Software dependencies
...
* [pip-licenses](https://github.com/raimon49/pip-licenses) ⭐ 374 | 🐛 44 | 🌐 Python | 📅 2026-09-09 - Dump the software license list of Python packages installed with pip.
